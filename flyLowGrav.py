...
class Fly:
    def __init__(self, args):
        ...
        self.energy_cost_scale = 1 # was 0.05 #TODO 
    ...
    def step(self, actions):
        ...
        #    print(self.actions.view(1, self.num_act*self.args.num_envs).squeeze(0)[:self.num_act]- actions.view(1, self.num_act*self.args.num_envs).squeeze(0)[:self.num_act])
